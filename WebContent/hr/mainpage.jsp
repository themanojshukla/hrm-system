...
<h3>
<br>
<a href="<%=request.getContextPath() %>/hr/candidates">List of All Candidates</a>
<br><br>
<a href="<%=request.getContextPath() %>/hr/candidates/new">New Candidates (Send for screening)</a>
<br><br>
<a href="<%=request.getContextPath() %>/hr/candidates/screenings">Candidates already in Screening</a>
<br><br>
<a href="<%=request.getContextPath() %>/hr/candidates/interviews">Candidates sent for Interview</a>
<br><br>
<a href="<%=request.getContextPath() %>/hr/candidates/finalists">Candidates for HR-Round</a>
<br><br>
<a href="<%=request.getContextPath() %>/hr/candidates/ctcs">Final Selected Candidates</a>
<br><br>
</h3>
</th>
<td style="width: 75%;">
...
<br>
<form action="<%=request.getContextPath() %>/hr/candidates" method="POST" enctype="multipart/form-data">
